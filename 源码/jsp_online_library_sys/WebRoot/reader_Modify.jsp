		...
		<div id="right">
			...
			<div id="right-buttom" style="overflow: auto;">
				<%
					...
					int typeID = 0;
				%>
				<form name="form1" action="reader?action=readerModify">
					<table id="table1" width="600" height="432" border="0" cellpadding="0"
						...
						<tr>
							...
							<td height="35"><input name="sex" type="radio"
								class="noborder" id="radiobutton" value="��"
								<%if ("��".equals(sex))
				out.println("checked");%>> <label
								for="radiobutton">�� </label> <label> <input name="sex"
									type="radio" class="noborder" value="Ů"
									<%if ("Ů".equals(sex))
				out.println("checked");%>> Ů
							</label></td>
						</tr>
						<tr>
					...
					out.println("selected");%>><%=typeName%></option>
						...
						<tr>
							...
							<td><select name="paperType" class="wenbenkuang"
								id="paperType">
									<option value="����֤"
										<%if ("����֤".equals(paperType))
				out.println(" selected");%>>����֤</option>
									<option value="ѧ��֤"
										<%if ("ѧ��֤".equals(paperType))
				out.println(" selected");%>>ѧ��֤</option>
									<option value="����֤"
										<%if ("����֤".equals(paperType))
				out.println(" selected");%>>����֤</option>
									<option value="����֤"
