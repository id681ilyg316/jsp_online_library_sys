									...
									<td valign="top" bgcolor="#00a9da">
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="0"
											...
											<form name="form1" method="post"
												action="borrow?action=bookrenew">
									...
									<td valign="top"><table width="100%" height="35"
											...
											<tr align="center" bgcolor="#e3F4F7">
												...
												<td width="12%" bgcolor="#00a9da"><input
													name="Button22" type="button" class="btn_grey" value="完成续借"
													onClick="window.location.href='bookRenew.jsp'"></td>
											</tr>
											<%
												int id = 0;
												String bookname = "";
											...
											<tr>
												...
												<td width="12%" align="center"><a
													href="borrow?action=bookrenew&barcode=<%=barcode%>&id=<%=id%>">续借</a>&nbsp;</td>
											</tr>
											<%
												}
												}
