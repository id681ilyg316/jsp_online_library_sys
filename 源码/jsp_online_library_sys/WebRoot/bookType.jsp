		...
		<div id="right">
			...
			<div id="right-buttom" style="overflow: auto;">
				...
				<table id="table1" border="0" cellspacing="" cellpadding="">
					<tr>
						<td align="center">
							<button type="button" id="orangeButton">添加图书类型信息
						</td>
					</tr>
					<tr>
				...
				<table id="table1" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td align="right"><a
							onClick="window.open('bookType_add.jsp','','width=292,height=160,top=250,left=550')"><button
									type="button" id="orangeButton">添加图书类型信息</a>
							</button></td>
					</tr>
					<tr>
						<td>
							<table id="table2" border="1px" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td align="center"><button type="button" id="blueButton">
											<a
												onClick="window.open('bookType?action=bookTypeModifyQuery&ID=<%=ID%>','','width=292,height=175,top=250,left=550')">修改</a>
										</button>&nbsp
										<button type="button" id="redButton">
											<a href="bookType?action=bookTypeDel&ID=<%=ID%>">删除</a>
										</button></td>
								</tr>
								<%
									}
